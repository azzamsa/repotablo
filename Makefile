...
comply: fmt ## Tasks to make the code-base comply with the rules. Mostly used in git hooks.

check: fmt_check ## Check if the repository comply with the rules and ready to be pushed.
